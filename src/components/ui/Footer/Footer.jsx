        ...
        <div className="footer-main">
          <div className="footer-about" ref={aboutRef}>
            <div className="footer-logo">
              <img src={spanaLogo} alt="Spana logo" className="footer-logo-image" />
              <div className="logo-accent"></div>
            </div>
            <p>
              Spana helps you discover, compare and book trusted service providers near you. Everything stays in one
              place – from discovery to booking – so you always know who is doing the work.
            </p>
...
git branch -M main
git remote add origin https://github.com/Spana-App/Spana-Website.git
